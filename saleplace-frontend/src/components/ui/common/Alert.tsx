...
function AlertTitle({ className, ...props }: ComponentProps<"div">) {
    return (
        <div
            ...
            className={cn(
                "font-medium tracking-wide group-has-[>svg]/alert:col-start-2 [&_a]:hover:text-foreground [&_a]:underline [&_a]:underline-offset-3",
                className
            )}
            {...props}
        />
...
function AlertDescription({
    ...
    return (
        <div
            ...
            className={cn(
                "text-muted-foreground text-sm mt-1 text-balance md:text-pretty [&_p:not(:last-child)]:mb-4 [&_a]:hover:text-foreground [&_a]:underline [&_a]:underline-offset-3",
                className
            )}
            {...props}
        />
